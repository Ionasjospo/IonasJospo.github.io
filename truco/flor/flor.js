    ...
    if (!numerosInvalidos.includes(numeroMuestra) && !numerosInvalidos.includes(numCarta1) && !numerosInvalidos.includes(numCarta2) &&
        ...
        if (noNulas(numeroMuestra, palo_muestra, numCarta1, palo_carta1, numCarta2, palo_carta2, numCarta3, palo_carta3) == true) {
            if (distintasCartas(numeroMuestra, palo_muestra, numCarta1, palo_carta1, numCarta2, palo_carta2, numCarta3, palo_carta3) == true) {
                ...
                if (posibles_muestras.includes(numeroMuestra)) {
                    //12
                    var pal12 = [2, 4, 5, 10, 11, 12];
                    //Identifica las muestras y la que no son muestra
                    ...
                    if (muestras.length == 3) {
                        return flor3Muestras(numeroMuestra, palo_muestra, numCarta1, palo_carta1, numCarta2, palo_carta2, numCarta3, palo_carta3, explicacion)
                    } else if (muestras.length == 2) {
                        return flor2Muestras(numeroMuestra, palo_muestra, numCarta1, palo_carta1, numCarta2, palo_carta2, numCarta3, palo_carta3, explicacion)
                    } else if (muestras.length == 1) {
                        return flor1Muestra(numeroMuestra, palo_muestra, numCarta1, palo_carta1, numCarta2, palo_carta2, numCarta3, palo_carta3, explicacion)
                    } else {
                        return flor0Muestras(numeroMuestra, palo_muestra, numCarta1, palo_carta1, numCarta2, palo_carta2, numCarta3, palo_carta3, explicacion)
                    }
...
function calcularFlor() {
    ...
    if (!numerosInvalidos.includes(num_muestra) && !numerosInvalidos.includes(numCarta1) && !numerosInvalidos.includes(numCarta2) &&
        !numerosInvalidos.includes(numCarta3)) {
        if (noNulas(num_muestra, palo_muestra, numCarta1, palo_carta1, numCarta2, palo_carta2, numCarta3, palo_carta3) == true) {
            if (distintasCartas(num_muestra, palo_muestra, numCarta1, palo_carta1, numCarta2, palo_carta2, numCarta3, palo_carta3) == true) {
                ...
                if (muestras.length == 3) {
                    ...
                    //ver como hacer para transformar para atras para mandar el num no el valor.
                    var muestra_mayor = Math.max(valor_c1, valor_c2, valor_c3)
                    
                    explicacion = flor_3Muestras()
                    return explicacion
                } else if (muestras.length == 2) {
                    explicacion = flor_3Muestras()
                    return explicacion 
...
*/
function flor_1muestra(num_muestra_ronda, num_muestra, palo_muestra, num_no_muestra1, palo_no_muestra1, num_no_muestra1, palo_no_muestra2) {
    var valores = { 2: 30, 4: 29, 5: 28, 11: 27, 10: 27 }
